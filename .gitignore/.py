#! Python
# Goes to bookshelf and downloads questions from the textbooks
...
# Specifying year and level of books blocked for now


# Creating a folder for the documents, blank file location
...
with requests.Session() as s:
    ...
    for book in isbnList:
        ...
        newLocation = startingLocation + '\' + r'\ ' + book['title']
        ...
        for tag in tags:
            ...
            for link in links:
                ...
                if readingRegex.search(text):
                    ...
                    figures = soupReading.findAll({"class": "chapter-review-H1"})
                    if len(figures) >= 1:
